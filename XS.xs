...
/* ======================================================================= */
UV CHARDATAMANY_NEGATIVE_LOOKAHEAD[]    = { /* ']', */ ']', '>' };
UV COMMENTCHARMANY_NEGATIVE_LOOKAHEAD[] = { /* '-', */ '-'      };
UV PITARGET_NEGATIVE_LOOKAHEAD1[]       = { /* 'x', */ 'm', 'l' };
UV PITARGET_NEGATIVE_LOOKAHEAD2[]       = { /* 'x', */ 'm', 'L' };
UV PITARGET_NEGATIVE_LOOKAHEAD3[]       = { /* 'x', */ 'M', 'l' };
UV PITARGET_NEGATIVE_LOOKAHEAD4[]       = { /* 'x', */ 'M', 'L' };
UV CDATAMANY_NEGATIVE_LOOKAHEAD[]       = { /* ']', */ ']', '>' };
UV PICHARDATAMANY_NEGATIVE_LOOKAHEAD[]  = { /* '?', */ '>'      };
UV IGNOREMANY_NEGATIVE_LOOKAHEAD1[]     = { /* '<', */ '!', '[' };
UV IGNOREMANY_NEGATIVE_LOOKAHEAD2[]     = { /* ']', */ ']', '>' };
...
XML_FUNC_DECL(is_XML_NAME_TRAILER, XML_NAME_TRAILER_ASCII(), XML_NAME_TRAILER_UTF8(), rc, XML_NO_USERCODE())
...
XML_FUNC_DECL(is_XML_NMTOKENMANY, XML_NMTOKENMANY_ASCII(), XML_NMTOKENMANY_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_ENTITYVALUEINTERIORDQUOTEUNIT_UTF8() XML_ENTITYVALUEINTERIORDQUOTEUNIT_ASCII()

XML_FUNC_DECL(is_XML_ENTITYVALUEINTERIORDQUOTEUNIT, XML_ENTITYVALUEINTERIORDQUOTEUNIT_ASCII(), XML_ENTITYVALUEINTERIORDQUOTEUNIT_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_ENTITYVALUEINTERIORSQUOTEUNIT_UTF8() XML_ENTITYVALUEINTERIORSQUOTEUNIT_ASCII()

XML_FUNC_DECL(is_XML_ENTITYVALUEINTERIORSQUOTEUNIT, XML_ENTITYVALUEINTERIORSQUOTEUNIT_ASCII(), XML_ENTITYVALUEINTERIORSQUOTEUNIT_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_ATTVALUEINTERIORDQUOTEUNIT_UTF8() XML_ATTVALUEINTERIORDQUOTEUNIT_ASCII()

XML_FUNC_DECL(is_XML_ATTVALUEINTERIORDQUOTEUNIT, XML_ATTVALUEINTERIORDQUOTEUNIT_ASCII(), XML_ATTVALUEINTERIORDQUOTEUNIT_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_ATTVALUEINTERIORSQUOTEUNIT_UTF8() XML_ATTVALUEINTERIORSQUOTEUNIT_ASCII()

XML_FUNC_DECL(is_XML_ATTVALUEINTERIORSQUOTEUNIT, XML_ATTVALUEINTERIORSQUOTEUNIT_ASCII(), XML_ATTVALUEINTERIORSQUOTEUNIT_UTF8(), rc, XML_NO_USERCODE())
...
XML_FUNC_DECL(is_XML_NOT_DQUOTEMANY, XML_NOT_DQUOTEMANY_ASCII(), XML_NOT_DQUOTEMANY_UTF8(), rc, XML_NO_USERCODE())
...
XML_FUNC_DECL(is_XML_NOT_SQUOTEMANY, XML_NOT_SQUOTEMANY_ASCII(), XML_NOT_SQUOTEMANY_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_CHARDATAMANY_LOOKAHEAD() ((! XML_IS_CHAR(']')) || ! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(CHARDATAMANY_NEGATIVE_LOOKAHEAD), CHARDATAMANY_NEGATIVE_LOOKAHEAD, true))

XML_FUNC_DECL(is_XML_CHARDATAMANY,
...
#define XML_COMMENTCHARMANY_LOOKAHEAD() ((! XML_IS_CHAR('-')) || ! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(COMMENTCHARMANY_NEGATIVE_LOOKAHEAD), COMMENTCHARMANY_NEGATIVE_LOOKAHEAD, true))

XML_FUNC_DECL(is_XML_COMMENTCHARMANY,
...
#define XML_PITARGET_LOOKAHEAD() ((! (XML_IS_CHAR('x') || XML_IS_CHAR('X'))) || (! (_is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(PITARGET_NEGATIVE_LOOKAHEAD1), PITARGET_NEGATIVE_LOOKAHEAD1, false) || _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(PITARGET_NEGATIVE_LOOKAHEAD2), PITARGET_NEGATIVE_LOOKAHEAD2, false) || _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(PITARGET_NEGATIVE_LOOKAHEAD3), PITARGET_NEGATIVE_LOOKAHEAD3, false) || _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(PITARGET_NEGATIVE_LOOKAHEAD4), PITARGET_NEGATIVE_LOOKAHEAD4, false))))

/* We start the exclusion in the test: /xml/i must not match and, if it matches, this will be at first pos */
XML_FUNC_DECL(is_XML_PITARGET,
...
#define XML_CDATAMANY_LOOKAHEAD() ((! XML_IS_CHAR(']')) || ! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(CDATAMANY_NEGATIVE_LOOKAHEAD), CDATAMANY_NEGATIVE_LOOKAHEAD, true))

XML_FUNC_DECL(is_XML_CDATAMANY,
...
#define XML_PICHARDATAMANY_LOOKAHEAD() ((! XML_IS_CHAR('?')) || ! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(PICHARDATAMANY_NEGATIVE_LOOKAHEAD), PICHARDATAMANY_NEGATIVE_LOOKAHEAD, true))

XML_FUNC_DECL(is_XML_PICHARDATAMANY,
...
#define XML_IGNOREMANY_LOOKAHEAD() ((! XML_IS_CHAR('<') && ! XML_IS_CHAR(']')) || (XML_IS_CHAR('<') ? (! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(IGNOREMANY_NEGATIVE_LOOKAHEAD1), IGNOREMANY_NEGATIVE_LOOKAHEAD1, true)) : (! _is_XML_STRING(aTHX_ sv, 0, s+ulen, send, XML_ARRAY_LENGTH(IGNOREMANY_NEGATIVE_LOOKAHEAD2), IGNOREMANY_NEGATIVE_LOOKAHEAD2, true))))

XML_FUNC_DECL(is_XML_IGNOREMANY,
...
/* _DIGITMANY => qr{\G[0-9]++} */
#define XML_DIGITMANY_ASCII() XML_IS_RANGE('0', '9')

#define XML_DIGITMANY_UTF8()  XML_DIGITMANY_ASCII()

XML_FUNC_DECL(is_XML_DIGITMANY, XML_DIGITMANY_ASCII(), XML_DIGITMANY_UTF8(), rc, XML_NO_USERCODE())

/* _ALPHAMANY => qr{\G[0-9a-fA-F]++} */
#define XML_ALPHAMANY_ASCII() (XML_IS_RANGE('0', '9') || XML_IS_RANGE('a', 'f') || XML_IS_RANGE('A', 'F'))

#define XML_ALPHAMANY_UTF8()  XML_ALPHAMANY_ASCII()

XML_FUNC_DECL(is_XML_ALPHAMANY, XML_ALPHAMANY_ASCII(), XML_ALPHAMANY_UTF8(), rc, XML_NO_USERCODE())
...
#define XML_ENCNAME_TRAILER_UTF8() XML_ENCNAME_TRAILER_ASCII()

XML_FUNC_DECL(is_XML_ENCNAME_TRAILER, XML_ENCNAME_TRAILER_ASCII(), XML_ENCNAME_TRAILER_UTF8(), rc, XML_NO_USERCODE())

#define XML_ENCNAME_HEADER_ASCII() (                \
  XML_IS_RANGE('A', 'Z')         ||                 \
  XML_IS_RANGE('a', 'z'))

#define XML_ENCNAME_HEADER_UTF8() XML_ENCNAME_HEADER_ASCII()

XML_FUNC_DECL(is_XML_ENCNAME,
              XML_ENCNAME_HEADER_ASCII(),
              XML_ENCNAME_HEADER_UTF8(), 
              rc,
              if (rc) { rc += is_XML_ENCNAME_TRAILER(aTHX_ sv, 0, s, send); }
              )

/* _S => qr{\G[\x{20}\x{9}\x{D}\x{A}]++} */

#define XML_S_ASCII() (XML_IS_CHAR(0x20) || XML_IS_CHAR(0x9) || XML_IS_CHAR(0xD) || XML_IS_CHAR(0xA))

#define XML_S_UTF8() XML_S_ASCII()

XML_FUNC_DECL(is_XML_S, XML_S_ASCII(), XML_S_UTF8(), rc, XML_NO_USERCODE())
